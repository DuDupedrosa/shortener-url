...
export default function DialogChangePassword() {
  ...
  function handleCloseDialog() {
    resetValues();
    closeDialog("dialog_change_password");
  }

  return (
    <dialog id="dialog_change_password" className="modal">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="mt-6 space-y-5">
          <div className="flex flex-col gap-1">
              ...
              <input
                ...
                {...register("currentPassword", {
                  onChange: (e) => {
                    ...
                    setValue("currentPassword", valueWithoutSpaces, {
                      shouldValidate: true,
                    });
                  },
                })}
            ...
            {errors.currentPassword?.message && (
              <ErrorInputMessage message={errors.currentPassword.message} />
            )}
          </div>
